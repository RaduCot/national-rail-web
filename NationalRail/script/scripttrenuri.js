...
function selectRow(row) {
    ...
    var vagoane = cells[1].innerText;
    var masa = cells[2].innerText;
    var vmax = cells[3].innerText;

    // Set the values in the textboxes
    document.getElementById('id').value = id;
    document.getElementById('vagoane').value = vagoane;
...
function addRow() {
    ...
    var vagoaneTextbox = document.getElementById('vagoane');
    var masaTextbox = document.getElementById('masa');
    var vmaxTextbox = document.getElementById('vmax');

    var vagoaneValue = vagoaneTextbox.value;
    var masaValue = masaTextbox.value;
    var vmaxValue = vmaxTextbox.value;

    var row = '<tr class="data-row" onclick="selectRow(this)"><td>' + id + '</td><td>' + vagoaneValue + '</td><td>' + masaValue + '</td><td>' + vmaxValue + '</td></tr>';
...
function modifyRow() {
    ...
    if (selectedRow) {
        ...
        cells[1].textContent = vagoaneValue;
        cells[2].textContent = masaValue;
        cells[3].textContent = vmaxValue;
    }
}
...
function deselectRow() {
    ...
    if (selectedRow) {
        ...
        document.getElementById('vagoane').value = '';
...
function exportRows() {
    ...
    saveAs(new Blob([wbout], { type: 'application/octet-stream' }), 'trenuri.xlsx');
}
