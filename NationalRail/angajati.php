...
<head>
    ...
    <script type="text/javascript" src="script/scriptangajati.js"></script>
            ...
            <div class="angajati-container3">
                <div class="angajati-container4">
                    ...
                    <table id="table" data-sort-order="asc">
                        <thead>
                            <tr>
                                <th onclick="sortTable(0)">id_angajat</th>
                                <th onclick="sortTable(1)">nume</th>
                                <th onclick="sortTable(2)">prenume</th>
                                <th onclick="sortTable(3)">cnp</th>
                                <th onclick="sortTable(4)">functie</th>
                                <th onclick="sortTable(5)">salariu</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
                            foreach ($rows as $row) {
                                ...
                                echo '<td>' . htmlspecialchars($row['salariu']) . '</td>';
                                echo '</tr>';
                            }
                            ?>
                        </tbody>
                ...
                <div class="angajati-sidebar">
                    <nav class="angajati-nav">
                        <div class="angajati-container7">
                            ...
                            <input id="nume" name="nume" type="text" placeholder="Nume"
                                class="angajati-textinput2 input" />
                            <input id="prenume" name="prenume" type="text" placeholder="Prenume"
                                class="angajati-textinput3 input" />
                            <input id="cnp" name="cnp" type="text" placeholder="CNP"
                                class="angajati-textinput4 input" />
                            <select id="functie" name="functie" class="angajati-select">
                                <option value="casier">casier</option>
                                <option value="mecanic">mecanic</option>
                                <option value="controlor">controlor</option>
                                <option value="director">director</option>
                                <option value="inspector">inspector</option>
                            </select>
                            <input id="salariu" name="salariu" type="text" placeholder="Salariu"
