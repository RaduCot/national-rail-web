...
$query = "DELETE FROM CALATORII";
$stmt = $pdo->prepare($query);
$stmt->execute();

// Prepare the SQL query for inserting data
$query = 'INSERT INTO CALATORII (id_calatorie, data_plecare, ora_plecare, data_sosire, ora_sosire, loc_plecare, loc_sosire, id_transport) VALUES ';
$placeholders = array();
$bindValues = array();
